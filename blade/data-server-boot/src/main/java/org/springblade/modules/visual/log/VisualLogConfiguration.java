...
@EnableConfigurationProperties(VisualLogProperties.class)
public class VisualLogConfiguration {

	@Bean
	public VisualLogAspect visualLogAspect(IVisualLogService logService, VisualLogProperties properties) {
		return new VisualLogAspect(logService,properties );
	}
