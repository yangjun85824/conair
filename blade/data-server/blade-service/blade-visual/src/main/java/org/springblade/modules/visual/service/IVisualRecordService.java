 ...
 * @author BladeX
 */
public interface IVisualRecordService extends BaseService<VisualRecord> {
	 ...
	 * @return
	 */
	IPage<VisualRecordVO> selectVisualRecordPage(IPage<VisualRecordVO> page, VisualRecordVO visualRecord);
