...
@WebServlet(name = "CodeRunServlet", urlPatterns = "/code/run")// 通过注解@WebServlet指定name和url
public class DynCodeServlet extends HttpServlet {

    public static Logger logger = LoggerFactory.getLogger(DynCodeServlet.class);
    @Override
...
//        resp.getWriter().print("Hello, servlet");
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        String codeCreate = req.getParameter("codeCreate");
        String executeM = req.getParameter("executeM");
